...
session.add_all([Offices(location="San Francisco"), Offices(location="Berlin"),
                 Offices(location="Taipei"), Offices(location="London"),
                 Offices(location="Seoul")])

session.add_all([Agents(agent_name="Favour", agent_email="okeke@gmail.com", agent_mobile="+1(512)351-0799"),
...
session.add_all([AgentOffice(office_id=1, agent_id=1), AgentOffice(office_id=1, agent_id=2),
...
session.add_all([Buyers(buyer_name="John", buyer_email="john@gmail.com", buyer_mobile="+1(512)345-0799"),
...
session.add_all([Sellers(seller_name="John", seller_email="john@gmail.com", seller_mobile="+1(512)345-0799"),
...
session.add_all([Houses(office_id=1, agent_id=1, seller_id=2, num_bedrooms=2, num_bathrooms=3,
                        listing_price=750000.00, zip_code=94102, listing_date=datetime.date(2022, 3, 25), sold=False),
                 Houses(office_id=4, agent_id=2, seller_id=5, num_bedrooms=1, num_bathrooms=3,
                        listing_price=500000.00, zip_code=53721, listing_date=datetime.date(2022, 3, 28), sold=False),
                 Houses(office_id=3, agent_id=5, seller_id=6, num_bedrooms=3, num_bathrooms=5,
                        listing_price=1200000.00, zip_code=81009, listing_date=datetime.date(2022, 3, 30), sold=False),
                 Houses(office_id=1, agent_id=2, seller_id=1, num_bedrooms=1, num_bathrooms=1,
                        listing_price=250000.00, zip_code=93102, listing_date=datetime.date(2022, 4, 20), sold=False),
                 Houses(office_id=3, agent_id=5, seller_id=3, num_bedrooms=2, num_bathrooms=2,
                        listing_price=300000.00, zip_code=82010, listing_date=datetime.date(2022, 4, 22), sold=False),
                 Houses(office_id=4, agent_id=2, seller_id=1, num_bedrooms=2, num_bathrooms=1,
                        listing_price=190000.00, zip_code=73682, listing_date=datetime.date(2022, 4, 25), sold=False),
                 Houses(office_id=5, agent_id=4, seller_id=2, num_bedrooms=3, num_bathrooms=2,
                        listing_price=450000.00, zip_code=48121, listing_date=datetime.date(2022, 4, 30), sold=False),
                 Houses(office_id=2, agent_id=1, seller_id=2, num_bedrooms=1, num_bathrooms=1,
                        listing_price=120000.00, zip_code=90017, listing_date=datetime.date(2022, 4, 30), sold=False)])
session.commit()
...
def make_sale(house_id, buyer_id, sale_price, sale_date):
    ...
    new_sale = Sales(house_id=house_id, buyer_id=buyer_id, sale_price=sale_price, sale_date=sale_date, commission=commission)
    session.add(new_sale)

    session.query(Houses).filter_by(house_id=house_id).update({"sold": True})
